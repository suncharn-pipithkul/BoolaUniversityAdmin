 ...
 */
public class CourseWithCheckBox
{
    /**
     * Member variables
     */
     ...
     * @param credits 
     */
    public CourseWithCheckBox(String courseId, String name, String day, Time start, Time end, String room, int credits)
    {
